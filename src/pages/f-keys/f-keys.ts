...
/**
 * Generated class for the FKeysPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-f-keys',
  templateUrl: 'f-keys.html',
})
export class FKeysPage {
    ...
    for (let entry of  this.datakey) {
      ...
      if(sumdata==""){
       ...
       let body = {
        ...
        DK_KeyType: sumdata,
        DK_Symbol: this.postdata.FSymbol,
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FKeysPage');
