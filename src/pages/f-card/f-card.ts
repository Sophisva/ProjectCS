...
/**
 * Generated class for the FCardPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-f-card',
  templateUrl: 'f-card.html',
})
export class FCardPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FCardPage');
  }
